...
class SRModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.net_g = self.model_to_device(self.net_g) # compile model
    ...
    def optimize_parameters(self, current_iter):
        ...
        # if self.opt['train']['use_grad_clip']:
            # if current_iter > 300000 and current_iter % 4 == 0:
                # torch.nn.utils.clip_grad_norm_(self.net_g.parameters(), 0.01)
    ...
    def test_selfensemble(self):
        ...
        lq_list = [self.lq]
        for tf in 'v', 'h', 't':
            lq_list.extend([_transform(t, tf) for t in lq_list]) # o, v, h, vh, t, vt, ht, vht
        ...
        # self.output = output.median(dim=0, keepdim=True)[0]
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        ensemble = self.opt['val'].get('ensemble', False)
