...
def main(args):
    ...
    for i, img_path in enumerate(img_list):
        ...
        print(f'{i+1:3d}: {basename:25}.\t NIQE: {niqe_score[0][0]:.6f}')
        niqe_all.append(niqe_score[0][0])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, default='/data1/lihao/projects/BasicSR/VideoLQresult/RealBasicVSR', help='Input path')
