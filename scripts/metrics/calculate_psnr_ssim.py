...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/data1/lihao/datasets/VSR/udm10/GT', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/data1/lihao/projects/mmediting/work_dirs/rfebasicvsr_c64n7_4x2_300k_fft_vimeo90k_bd/udm10_300k', help='Path to restored images')
