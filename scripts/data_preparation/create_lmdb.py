...
def create_lmdb_for_lsdir():
    # HR images
    folder_path = '/data0/NTIRE_denoising/DIV2K_LSDIR_HR/LSDIR_DIV2K'
    lmdb_path = '/data1/NTIRE_denoising/datasets/DIV2K_train_HR_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
def create_lmdb_for_reds():
    ...
    """
    # train_sharp
    folder_path = '/data1/lihao/datasets/VSR/REDS/train_sharp'
    ...
    # train_sharp_bicubic
    folder_path = '/data1/lihao/datasets/VSR/REDS/train_sharp_bicubic'
...
def create_lmdb_for_vimeo90k():
    ...
    lmdb_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo90k_train_GT_only4th.lmdb'
    ...
    # LQ
    folder_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo_septuplet_matlabLRx4/sequences'
    lmdb_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo90k_train_LR7frames.lmdb'
    train_list_path = '/data1/lihao/datasets/VSR/vimeo90k/vimeo_septuplet/sep_trainlist.txt'
